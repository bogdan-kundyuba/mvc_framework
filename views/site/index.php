...
<?php //require_once ROOT. "/models/Product.php"; ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        ...
                                        <?php if ($product['is_new']) { ?>
                                            <img src="/public/images/home/new.png" class='new'>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="recommended_items"><!--recommended_items-->
                        ...
                        <?php foreach ($sliderProd as $sliderItem) { ?>
                                <div class="item">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="<?php echo \models\Product::getImage($sliderItem['id']); ?>"
                                                     alt=""/>
                                                <h2>$<?php echo $sliderItem['price']; ?></h2>
                                                <a href="/product/<?php echo $sliderItem['id']; ?>">
                                                    <?php echo $sliderItem['name']; ?>
                                                <br><br>
                                                <a href="http://mysite.loc/cart/add/<?php echo $sliderItem['id']; ?>"
                                                   class="btn btn-default add-to-cart"
